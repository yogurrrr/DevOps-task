...
int main()
{
    ...
    if (c > 0) {
        ...
        while (c2 != -1)
        {
            char str2[1000] = { 0 };
            int i = 0; int len2 = 0;
            while (variables[c2][i] != '=')i++; i += 2; int perezap = i; // � ����� ����� ������ �������������� ���������
            ...
            COMPLEX Itog2 = itog(polsk2, vivod2, variables2, str2, len2, tsifri2, znaki2, i2, noprint);//��� ��������� � ����������� ����, ������ ���� �������� �� ��������
            if (Itog2.real == 8889 && Itog2.imag == -9998) {
                zero = 1; break;
            }
            // ����� ����� ���������� �������, ������ ����������� Itog2 �� double � char � ������������ ������ � variables[c2];
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////!!!!!!!!!!!! ����� �������� ���������
    ...
    //        char polsk2[100] = { 0 };
    //        char vivod2[100]; STACK* tsifri2 = NULL;  //���� � �������
    //        STACKzn* znaki2 = 0;
